# 2025 Student Meeting

Jax -> seems a little more real-world
...
Is it one senior per role?
- May not exactly be seniors, but only one person per role

JAX -> Would be good to have a vote
- Plan to have mentors + outgoing student decide or students above depending on role

What is the captain's job?
- Face of the team, have them lead that portion of the meeting
- Core leadership meeting to discuss robot status
- 4423 is an intro

JAX -> Could we flatten the structure?
- removes growth opportunities for the leaders

? -> Stuff might get lost with narrowing the structure
- Not attempting to remove the mentors working closely with all

Checkpoints on weds and friday each week
- feels like we should keep around here

Eli -> Concern over leading the entire team
...
- feels unnecessary, already working side by side
